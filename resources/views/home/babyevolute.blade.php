...
<body>
    <header>
        <h1>Dynamic Image Based on SVG</h1>
    </header>

    <main>
        <!-- SVGを表示するコンテナ -->
        <div id="selectedIconContainer">
            <!-- セッションストレージから取得したSVGが表示される -->
        </div>

        <!-- 対応する画像を表示するためのimg要素 -->
        <img id="imagePlaceholder" src="" alt="">

        <!-- デバッグ用にSVGの内容を表示するためのpre要素 -->
        <pre id="svgContent"></pre>
    </main>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // 対応する画像のパス
            var imagePath = "/images/picture1.png"; // 画像のパスを適切に指定する
            ...
            // デバッグ用にSVGの内容を表示
            document.getElementById("svgContent").textContent = selectedIcon;
        });
    </script>
</body>
</html>
